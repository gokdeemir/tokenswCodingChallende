...
public class PaymentController {
    ...
    @PostMapping(value = "/pay-with-qr", consumes = {"multipart/form-data"})
    public ResponseEntity<JsonNode> payWithQR(@RequestPart @Valid Payment payment) {
    ...
    public ResponseEntity<JsonNode> refundWithQR(@RequestBody @Valid Refund refund) {
    ...
    public ResponseEntity<JsonNode> getBatchSummary(@RequestBody @Valid BatchSummary batchSummary) {
    ...
    public ResponseEntity<JsonNode> getTransaction(@RequestBody @Valid Transaction transaction) {
